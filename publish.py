...
if __name__=="__main__":
    ...
    print(f"Publishing: {args.title} -> {args.file}..")
    ...
    publish_response = json.loads(publish_response.text)

    published_url = f"{posts_url}/{publish_response['id']}"
